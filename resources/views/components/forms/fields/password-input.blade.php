{{-- resources/views/components/forms/fields/password-input.blade.php --}}
@php
    ...
    <div class="password-input-wrapper">
        ...
        @if($showToggle ?? true)
            <button type="button" class="password-toggle" data-password-toggle aria-label="Toggle password visibility">
                ...
                <svg class="icon-eye-off hidden" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
